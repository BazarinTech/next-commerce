    ...
    <div className="bg-zinc-200 h-screen">
      ...
      <div className="w-full px-4 py-2">
        <div className="w-full bg-white rounded-lg px-4 py-2">
          ...
          Kilion Commerce Limited is a leading e-commerce company in United Kingdom. It was founded in 2013 by a group of young entrepreneurs who wanted to create a platform where customers could buy products online with ease. The company started with a small team and a limited product range, but it quickly gained popularity and expanded its operations to become one of the largest e-commerce companies in the country.
          </p>
        </div>
      </div>
      <div className="w-full px-4 py-2">
